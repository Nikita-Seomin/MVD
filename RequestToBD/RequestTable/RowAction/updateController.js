        ...
        async.waterfall([
            ...
            function (callback) {
                ...
                connection.query(sql, [region], (err, results) => {
                    ...
                    callback(null, results[0]['idRegion']);
                });
            },
            //check division where material sent
            function (idRegion, callback) {
                ...
                connection.query(sql, [whereSent], (err, results) => {
                    ...
                    callback(null,idRegion, results[0]['idUsers']);
                });
            },

            //SELECT old row
            function (idRegion,idDivision, callback) {
                ...
                connection.query(sql, [idRequestTable], (err, results) => {
                    ...
                    callback(null, idRegion,idDivision, results[0]);
                });
            },

            //-----------------UPDATE-REQUEST-TABLE-DATA-----------------------------------------

            function (idRegion, idDivision, oldRow, callback) {
